         ...
         <main >
            ...
            <div id="section" className="item">
               <div className="carousel">
                  <input type="radio" name="carousel" id="1" defaultChecked="checked" className="carousel__activator" />
                  <input type="radio" name="carousel" id="2" className="carousel__activator" />
                  <input type="radio" name="carousel" id="3" className="carousel__activator" />
                  <input type="radio" name="carousel" id="4" className="carousel__activator" />
                  <input type="radio" name="carousel" id="5" className="carousel__activator" />
                  <div className="carousel__controls">
                     <label htmlFor="5" className="carousel__control carousel__control--previous"></label>
                     <label htmlFor="2" className="carousel__control carousel__control--next"></label>
                  </div>
                  <div className="carousel__controls">
                     <label htmlFor="1" className="carousel__control carousel__control--previous"></label>
                     <label htmlFor="3" className="carousel__control carousel__control--next"></label>
                  </div>
                  <div className="carousel__controls">
                     <label htmlFor="2" className="carousel__control carousel__control--previous"></label>
                     <label htmlFor="4" className="carousel__control carousel__control--next"></label>
                  </div>
                  <div className="carousel__controls">
                     <label htmlFor="3" className="carousel__control carousel__control--previous"></label>
                     <label htmlFor="5" className="carousel__control carousel__control--next"></label>
                  </div>
                  <div className="carousel__controls">
                     <label htmlFor="4" className="carousel__control carousel__control--previous"></label>
                     <label htmlFor="1" className="carousel__control carousel__control--next"></label>
                  </div>
                  <div className="carousel__track">
                     <div className="carousel__slide">

                        <img src={"/image/call-of-duty-black-ops.jpg"} loading="lazy" alt="call of duty black ops" />
                     </div>
                     <div className="carousel__slide">

                        <img src={"/image/Hitman-2.jpg"}
                           loading="lazy" alt="hitman 2" />
                     </div>
                     <div className="carousel__slide">

                        <img className="img3"
                           src={"/image/fast-and-furious.jpg"}
                           loading="lazy" alt="fast furious showdown" />
                     </div>
                     <div className="carousel__slide">

                        <img src={"/image/freedom-fighter.jpg"}
                           loading="lazy" alt="freedom fighter 7" />
                     </div>
                     <div className="carousel__slide">

                        <img className="img5"
                           src={"/image/trialfusion.jpg"}
                           loading="lazy" alt="trial fusion" />
                     </div>
                  </div>
                        ...
                        return (
                           ...
                           >
                              ...
                              <div className="card">
                                 ...
                                 <img width={370} height={225} className="card-img-top" src={blogItems.main_image} alt={blogItems.title} />
