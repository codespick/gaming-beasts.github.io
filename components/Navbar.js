...
let scrollOfHomeScreenBlur = () => {
    if (document.querySelector(".navbar-toggler").classList.value !== "collapsed") {
...
process.browser && $(document).ready(function () {
        ...
        <>
            ...
            <div className="mainContainer">
                ...
                <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
                    ...
                    <button id="navbarMainBtn" onClick={() => { scrollOfHomeScreenBlur(); }} className="navbar-toggler" type="button" data-toggle="collapse"
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav mr-auto closed">
                            ...
                            <li className="nav-item dropdown"
                                id="dropdown1">
                                <Link href={"#"} >
                                    <a className="nav-Link dropdown-toggle" id="navbarDropdown1" role="button" data-toggle="dropdown"
                                        aria-haspopup="true" aria-expanded="false"> SIZE</a>
                                </Link>
                                <div className="dropdown-menu menu-3 stop-menu3"
                            ...
                            <li className="nav-item dropdown"
                                ...
                                <div className="dropdown-menu menu-3 stop-menu3"
                                    aria-labelledby="navbarDropdown1">
                                    <Link href={"/assassin-creed-games"}>

                                        <a className="dropdown-item">Assassins Creed Games</a>
                                    </Link>
                                    <Link href={"#"}>
                            ...
                            <li className="nav-item">
                                ...
                                <Link href={"/about"}>
                                    <a className="nav-Link" id="navbarDropdown1">ABOUT </a>
                                </Link>

                            </li>
                            <li className="nav-item login-btn">

                                <Link href={"/login"} ><a className="nav-Link login">LOGIN</a></Link>

                            </li>

                        </ul >
                        <span onClick={props.toggleSwitchIcon} className="moon-button">

                            <i className="moon-icon fa fa-moon-o" aria-hidden="true"></i>

                        </span>
                        <form className="form-inline my-2 my-lg-0">
                            <input className="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" />
                            <button className="search-btn btn btn-outline-primary my-2 my-sm-0" type="submit">Search</button>
                        </form>
                    </div >
                </nav >
            </div >
